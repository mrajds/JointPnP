...
if __name__ == '__main__':
    is_train = not True
    dropout = not True
    grasp_model_folder = '/models/reflex_grasp_inf_models/grasp_voxel_inf_net/'
    if is_train:
        ...
        logs_path = '/home/mohanraj/tf_logs/grasp_net_logs'
        update_voxel_enc = False #True
        if update_voxel_enc:
            grasp_model_path = pkg_path + grasp_model_folder + 'grasp_net_update_enc.ckpt'
        else:
            ...
            grasp_model_path = pkg_path + grasp_model_folder + 'grasp_voxel_net_reflex.ckpt'
