...
class GraspALServer:
    ...
    def __init__(self):
        ...
        # self.active_method = 'SINGLE_ARM_OPT'
        self.active_method = 'SINGLE_ARM_POOLING'
        ...
        if self.active_method == 'UCB':
            ...
            reward, ik_config_inf, config_inf, obj_val_inf, \
                    ik_config_init, config_init, obj_val_init, \
                        res_info = self.gal.ucb(voxel_grid, obj_size, 
                                                        pooling=True)
        elif self.active_method == 'SINGLE_ARM_OPT':
            single_arm_id = 2
            reward, ik_config_inf, config_inf, obj_val_inf, \
                    ik_config_init, config_init, obj_val_init, \
                        res_info = self.gal.single_arm(voxel_grid, obj_size, 
                                                        arm_id=single_arm_id)
        elif self.active_method == 'SINGLE_ARM_POOLING':
            single_arm_id = 2
            reward, ik_config_inf, config_inf, obj_val_inf, \
                    ik_config_init, config_init, obj_val_init, \
                        res_info = self.gal.single_arm(voxel_grid, obj_size, 
