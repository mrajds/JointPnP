...
SOLUTION = np.array([-2.3184367783296964, -1.3073410995051122, -1.2306316345787904, -1.6346000566576617, -1.2333566947533545, 1.8001255091749746, 0.9484343912624346, 1.6960771598214768, -1.237931531889741, 2.0956140249046, -0.766434717178031, -2.173162004076734, -1.3464596414278862, -2.64326465168617, 0.5978731246592885])
...
def joint_init(pblm, num_inits=5, full_cost=False, debug=True):
    fig_loc = '/home/mohanraj/temp/'
    inits = []
    costs = []
    rospy.loginfo('Generating coarse scene grid')
